...
> = {
  ...
  en: {
    navHome: "← Home",
    heroEyebrow: "For electricians and mobile electrician",
    heroTitle: "Get more electrician clients in San Miguel.",
    ...
    ctaPrimary: "Sign up as a electrician",
    ...
    buyerEyebrow: "Need a electrician?",
