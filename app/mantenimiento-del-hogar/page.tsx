...
import { handymanStarterMenu } from "@/lib/listing-service-menu";
import { HANDYMAN_SERVICE } from "@/lib/provider-services";
...
> = {
  es: {
    navHome: "← Inicio",
    heroEyebrow: "Para handyman y mantenimiento del hogar a domicilio",
    heroTitle: "Consigue más clientes de reparaciones en San Miguel.",
    ...
    ctaPrimary: "Registrarme como handyman",
    ...
    whySub: "Tres razones para publicar mantenimiento del hogar en SMA.",
    why1Title: "Clientes que buscan reparaciones reales",
    why1Body: "Familias y expatriados te encuentran para pintura, drywall, puertas, repisas y arreglos generales en su colonia.",
    why2Title: "Cotización antes de pagar",
    why2Body: "Visitas el domicilio, ajustas el presupuesto en la app y el cliente acepta antes del depósito.",
    why3Title: "Menú claro + materiales aparte",
    why3Body: "Publicas precios de referencia por trabajo. Materiales se confirman en visita — el total final va en la cotización oficial.",
    ...
    how2Body: "Plantilla con 19 trabajos típicos (puertas, pintura, drywall, repisas, persianas, etc.). Ajustas precios a tu zona.",
    ...
    faq4A: "Ajustas líneas y total en el chat antes de que el cliente acepte.",
    ...
    buyerEyebrow: "¿Buscas handyman?",
    buyerTitle: "Encuentra mantenimiento del hogar cerca de ti.",
    buyerSub: "Técnicos verificados en San Miguel con menú y cotización en la app.",
    buyerCta: "Ver handyman en SMA",
  ...
  en: {
    navHome: "← Home",
    heroEyebrow: "For handymen and home maintenance pros",
    heroTitle: "Get more repair clients in San Miguel.",
    ...
    ctaPrimary: "Sign up as a handyman",
    ctaSecondary: "See how it works",
    badgeFree: "Free signup",
    badgeVerified: "Verified profile",
    badgeReach: "Expats & local families",
    whyTitle: "Why join?",
    whySub: "Three reasons to list home maintenance in SMA.",
    why1Title: "Customers searching for real repairs",
    why1Body: "Families and expats find you for painting, drywall, doors, shelves, and general fixes in their neighborhood.",
    ...
    why3Body: "Publish reference labor prices. Materials confirmed on site — final total in the official quote.",
    ...
    how2Body: "Template with 19 typical jobs (doors, paint, drywall, shelves, blinds, etc.). Adjust for your area.",
    ...
    buyerEyebrow: "Need a handyman?",
    buyerTitle: "Find home maintenance near you.",
    buyerSub: "Verified handymen in San Miguel with in-app quotes.",
    buyerCta: "Browse handymen in SMA",
...
export function generateMetadata({
  ...
  const title =
    lang === "es"
      ? "Mantenimiento del hogar en San Miguel de Allende | Naranjogo"
      : "Handyman services in San Miguel de Allende | Naranjogo";
  return {
    title,
...
export default function MantenimientoDelHogarLandingPage({
  searchParams,
}: {
  searchParams?: { lang?: string };
}) {
  const lang = langFromParam(searchParams?.lang);
  const t = COPY[lang];
  const menu = handymanStarterMenu();
  ...
  const signupHref = `/unete?service=${HANDYMAN_SERVICE}&lang=${lang}`;
  const browseHref = `/?category=services&q=${encodeURIComponent(
    lang === "es" ? "mantenimiento_hogar" : "handyman",
  )}&lang=${lang}`;
      ...
      <div className="max-w-3xl mx-auto px-4 pb-16">
        <header className="flex items-center justify-between py-6">
          ...
          <div className="flex bg-white rounded-lg p-1 gap-1 border border-[#E5E0D8]">
            ...
            <Link
              href={`/mantenimiento-del-hogar?lang=${otherLang}`}
