...
export function buyerMenuPickerTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en" ? "What plumbing work do you need?" : "¿Qué trabajo de plomería necesitas?";
  }
...
export function serviceRequestNoun(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en" ? "plumbing request" : "solicitud de plomería";
  }
...
export function serviceDepositConfirmLine(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en"
      ? "Pay the deposit (platform fee) below to confirm your plumbing visit."
      : "Paga el depósito (tarifa de plataforma) abajo para confirmar tu visita de plomería.";
  }
  return lang === "en"
...
export function sellerRequestPanelEmoji(slug: string | null | undefined): string {
  ...
  if (slug === PLUMBING_SERVICE) return "🔧";
  return "📋";
}
...
export function notifyQuoteSentTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en" ? "📋 *New plumbing quote — Naranjogo*" : "📋 *Nueva cotización de plomería — Naranjogo*";
  }
...
export function notifyBuyerRequestTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en" ? "🔧 *New plumbing request — Naranjogo*" : "🔧 *Nueva solicitud de plomería — Naranjogo*";
  }
...
export function checkoutFullConnectBlockedMessage(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en"
      ? "For plumbing, pay the deposit (platform fee) first. The job balance is settled after the work is complete."
      : "Para plomería, paga primero el depósito (tarifa de plataforma). El saldo del trabajo se liquida al completar.";
  }
  return lang === "en"
...
export function supplementSummaryTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en" ? "Plumbing job summary" : "Resumen de plomería";
  }
...
export function supplementTipDescription(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en" ? "100% for your plumber" : "100% para tu plomero";
  }
...
export function notifyBuyerSupplementBalanceDueTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en" ? "✅ *Plumbing job completed — Naranjogo*" : "✅ *Trabajo de plomería completado — Naranjogo*";
  }
...
export function supplementCheckoutServiceLabel(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === PLUMBING_SERVICE) {
    return lang === "en" ? "Plumbing service" : "Servicio de plomería";
  }
