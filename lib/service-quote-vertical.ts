...
export function buyerMenuPickerTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en" ? "What electrician work do you need?" : "¿Qué trabajo de electricista necesitas?";
  }
...
export function serviceRequestNoun(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en" ? "electrician request" : "solicitud de electricista";
  }
...
export function serviceDepositConfirmLine(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en"
      ? "Pay the deposit (platform fee) below to confirm your electrician visit."
      : "Paga el depósito (tarifa de plataforma) abajo para confirmar tu visita de electricista.";
  }
  return lang === "en"
...
export function sellerRequestPanelEmoji(slug: string | null | undefined): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) return "⚡";
  return "📋";
}
...
export function notifyQuoteSentTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en" ? "📋 *New electrician quote — Naranjogo*" : "📋 *Nueva cotización de electricista — Naranjogo*";
  }
...
export function notifyBuyerRequestTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en" ? "⚡ *New electrician request — Naranjogo*" : "⚡ *Nueva solicitud de electricista — Naranjogo*";
  }
...
export function checkoutFullConnectBlockedMessage(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en"
      ? "For electrician, pay the deposit (platform fee) first. The job balance is settled after the work is complete."
      : "Para electricista, paga primero el depósito (tarifa de plataforma). El saldo del trabajo se liquida al completar.";
  }
  return lang === "en"
...
export function supplementSummaryTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en" ? "Electrician job summary" : "Resumen de electricista";
  }
...
export function supplementTipDescription(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en" ? "100% for your electrician" : "100% para tu electricista";
  }
...
export function notifyBuyerSupplementBalanceDueTitle(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en" ? "✅ *Electrician job completed — Naranjogo*" : "✅ *Trabajo de electricista completado — Naranjogo*";
  }
...
export function supplementCheckoutServiceLabel(slug: string | null | undefined, lang: "es" | "en"): string {
  ...
  if (slug === ELECTRICIAN_SERVICE) {
    return lang === "en" ? "Electrician service" : "Servicio de electricista";
  }
