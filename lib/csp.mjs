...
export const CSP_POLICY = [
  ...
  ["connect-src", "'self'", "https:", "wss:", "https://vitals.vercel-insights.com", "https://*.ingest.sentry.io", "https://*.ingest.us.sentry.io", "https://api.mapbox.com", "https://events.mapbox.com"].join(" "),
