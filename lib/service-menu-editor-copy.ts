...
const BASE = {
  es: {
    ...
    menuHintElectrician: "Lista reparaciones comunes con precio de referencia (mano de obra). Materiales se confirman en visita. Ajusta la cotización oficial en el chat después de inspeccionar.",
    ...
    menuTemplateBtnElectrician: "Cargar plantilla sugerida (16 servicios)",
    ...
    menuRowNamePhElectrician: "Nombre (ej. Reparar contacto dañado)",
    ...
    menuDisclaimerElectrician: "El precio es referencia. Puede ajustarse después de la visita al domicilio, inspección del trabajo y materiales necesarios.",
  ...
  en: {
    ...
    menuHintElectrician: "List common repairs at reference labor prices. Materials are confirmed on visit. Adjust the official quote in chat after inspection.",
    ...
    menuTemplateBtnElectrician: "Load suggested template (16 services)",
    ...
    menuRowNamePhElectrician: "Name (e.g. Outlet repair)",
    ...
    menuDisclaimerElectrician: "Prices are reference only. May change after on-site visit, job inspection, and required materials.",
...
export function getServiceMenuEditorCopy(
  ...
  if (providerSlug === ELECTRICIAN_SERVICE) {
    return {
      title: t.title,
      hint: t.menuHintElectrician,
      templateBtn: t.menuTemplateBtnElectrician,
      namePh: t.menuRowNamePhElectrician,
      disclaimer: t.menuDisclaimerElectrician,
      addRow: t.menuAddRow,
      empty: t.menuEmpty,
    };
  }
