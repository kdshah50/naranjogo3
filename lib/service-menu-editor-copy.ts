...
const BASE = {
  es: {
    ...
    menuHintHandyman: "Lista reparaciones comunes con precio de referencia (mano de obra). Materiales se confirman en visita. Ajusta la cotización oficial en el chat después de inspeccionar.",
    ...
    menuTemplateBtnHandyman: "Cargar plantilla sugerida (19 servicios)",
    ...
    menuRowNamePhHandyman: "Nombre (ej. Reparación drywall pequeña)",
    ...
    menuDisclaimerHandyman: "El precio es referencia. Puede ajustarse después de la visita al domicilio, inspección del trabajo y materiales necesarios.",
  ...
  en: {
    ...
    menuHintHandyman: "List common repairs at reference labor prices. Materials are confirmed on visit. Adjust the official quote in chat after inspection.",
    ...
    menuTemplateBtnHandyman: "Load suggested template (19 services)",
    ...
    menuRowNamePhHandyman: "Name (e.g. Small drywall patch)",
    ...
    menuDisclaimerHandyman: "Prices are reference only. May change after on-site visit, job inspection, and required materials.",
...
export function getServiceMenuEditorCopy(
  ...
  if (providerSlug === HANDYMAN_SERVICE) {
    return {
      title: t.title,
      hint: t.menuHintHandyman,
      templateBtn: t.menuTemplateBtnHandyman,
      namePh: t.menuRowNamePhHandyman,
      disclaimer: t.menuDisclaimerHandyman,
      addRow: t.menuAddRow,
      empty: t.menuEmpty,
    };
  }
